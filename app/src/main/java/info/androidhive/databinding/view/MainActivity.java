...
public class MainActivity extends AppCompatActivity implements PostsAdapter.PostsAdapterListener {
    ...
    private void renderProfile() {
        ...
        user.setProfileImage("http://thinnaikathai.com/apps/tangle/profile.jpg");
    ...
    private ArrayList<Post> getPosts() {
        ...
        for (int i = 1; i < 7; i++) {
            Post post = new Post();
            post.setImageUrl("http://thinnaikathai.com/apps/tangle/" + i + ".jpg");
            posts.add(post);
    ...
    public void onPostClicked(Post post) {
        ...
        String url= post.getImageUrl();
            if (Objects.equals(url, "http://thinnaikathai.com/apps/tangle/1.jpg"))
            {
                Intent intent = new Intent(this, WebViewActivity.class);
                startActivity(intent);
            }
            else if (Objects.equals(url, "http://thinnaikathai.com/apps/tangle/2.jpg"))
            {
                Intent intent = new Intent(this, WebViewActivity2.class);
                startActivity(intent);
            }

            else if (Objects.equals(url, "http://thinnaikathai.com/apps/tangle/3.jpg"))
            {
                Intent intent = new Intent(this, WebViewActivity3.class);
                startActivity(intent);
            }
            else if (Objects.equals(url, "http://thinnaikathai.com/apps/tangle/4.jpg"))
            {
                Intent intent = new Intent(this, WebViewActivity4.class);
                startActivity(intent);
            }
            else if (Objects.equals(url, "http://thinnaikathai.com/apps/tangle/5.jpg"))
            {
                startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("market://details?id=PackageName")));
            }
            else if (Objects.equals(url, "http://thinnaikathai.com/apps/tangle/6.jpg"))
            {
